...
# Custom CSS for better styling - SIMPLE AND CLEAN
st.markdown("""
<style>
    ...
    * {
    ...
    /* Universal text selector for better readability */
    ...
    /* Plotly chart improvements - SIMPLE AND CLEAN */
    .js-plotly-plot, .plotly-graph-div, [data-testid="stPlotlyChart"] {
        border: 1px solid #475569 !important;
    ...
    /* Force chart text to be visible on dark background */
